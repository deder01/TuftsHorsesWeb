...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'ShowInvitation'
        db.create_table('horseshow_showinvitation', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('showteam', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['horseshow.ShowTeam'])),
            ('rider', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.User'])),
            ('status', self.gf('django.db.models.fields.IntegerField')(default=-1)),
            ('uuid', self.gf('django.db.models.fields.CharField')(default='6f4136217c7811e2b62314109fe01d13', max_length=100)),
        ))
        db.send_create_signal('horseshow', ['ShowInvitation'])


    def backwards(self, orm):
        # Deleting model 'ShowInvitation'
        db.delete_table('horseshow_showinvitation')
    ...
    models = {
        ...
        'horseshow.showinvitation': {
            'Meta': {'object_name': 'ShowInvitation'},
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'rider': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['auth.User']"}),
            'showteam': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['horseshow.ShowTeam']"}),
            'status': ('django.db.models.fields.IntegerField', [], {'default': '-1'}),
            'uuid': ('django.db.models.fields.CharField', [], {'default': "'6f521ed77c7811e2967114109fe01d13'", 'max_length': '100'})
        },
        'horseshow.showteam': {
