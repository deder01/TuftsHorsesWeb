...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'HorseShow.dateStart'
        db.alter_column('horseshow_horseshow', 'dateStart', self.gf('django.db.models.fields.DateField')())

        # Changing field 'HorseShow.dateEnd'
        db.alter_column('horseshow_horseshow', 'dateEnd', self.gf('django.db.models.fields.DateField')())
        # Adding field 'Ring.eventLength'
        db.add_column('horseshow_ring', 'eventLength',
                      self.gf('django.db.models.fields.IntegerField')(default=20),
                      keep_default=False)

        # Adding field 'HorseShowDay.day'
        db.add_column('horseshow_horseshowday', 'day',
                      self.gf('django.db.models.fields.IntegerField')(default=1),
                      keep_default=False)

        # Adding field 'HorseShowDay.startTime'
        db.add_column('horseshow_horseshowday', 'startTime',
    ...
    def backwards(self, orm):
        ...
        # Changing field 'HorseShow.dateStart'
        db.alter_column('horseshow_horseshow', 'dateStart', self.gf('django.db.models.fields.DateTimeField')())

        # Changing field 'HorseShow.dateEnd'
        db.alter_column('horseshow_horseshow', 'dateEnd', self.gf('django.db.models.fields.DateTimeField')())
        # Deleting field 'Ring.eventLength'
        db.delete_column('horseshow_ring', 'eventLength')

        # Deleting field 'HorseShowDay.day'
        db.delete_column('horseshow_horseshowday', 'day')

        # Deleting field 'HorseShowDay.startTime'
        db.delete_column('horseshow_horseshowday', 'startTime')
