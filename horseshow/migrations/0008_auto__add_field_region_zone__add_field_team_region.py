...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Region.zone'
        db.add_column('horseshow_region', 'zone',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['horseshow.Zone'], null=True),
                      keep_default=False)

        # Removing M2M table for field teams on 'Region'
        db.delete_table('horseshow_region_teams')

        # Adding field 'Team.region'
        db.add_column('horseshow_team', 'region',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['horseshow.Region'], null=True),
                      keep_default=False)
    ...
    def backwards(self, orm):
        ...
        # Deleting field 'Region.zone'
        db.delete_column('horseshow_region', 'zone_id')
        ...
        # Deleting field 'Team.region'
        db.delete_column('horseshow_team', 'region_id')
    ...
    models = {
        ...
        'horseshow.horseshow': {
            ...
            'date': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 2, 2, 0, 0)'}),
