...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'HorseShow.barn'
        db.add_column('horseshow_horseshow', 'barn',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=100),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'HorseShow.barn'
        db.delete_column('horseshow_horseshow', 'barn')
    ...
    models = {
        ...
        'horseshow.horseshow': {
            ...
            'date': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 2, 5, 0, 0)'}),
