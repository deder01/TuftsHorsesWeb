...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'HorseShow.judge'
        db.add_column('horseshow_horseshow', 'judge',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=100),
                      keep_default=False)

        # Deleting field 'Class.judge'
        db.delete_column('horseshow_class', 'judge')


    def backwards(self, orm):
        # Deleting field 'HorseShow.judge'
        db.delete_column('horseshow_horseshow', 'judge')

        # Adding field 'Class.judge'
        db.add_column('horseshow_class', 'judge',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=100),
                      keep_default=False)
    ...
    models = {
        ...
        'horseshow.horseshow': {
            ...
            'date': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 3, 2, 0, 0)'}),
