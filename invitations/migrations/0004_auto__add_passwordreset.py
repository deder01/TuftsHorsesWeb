...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('invitations_passwordreset', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('uuid', self.gf('django.db.models.fields.CharField')(default='b6f4bf23753511e2823114109fe01d13', max_length=100)),
            ('date_issued', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, blank=True)),
            ('user', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.User'])),
        ))
        db.send_create_signal('invitations', ['PasswordReset'])


    def backwards(self, orm):
        # Deleting model 'PasswordReset'
        db.delete_table('invitations_passwordreset')
    ...
    models = {
        ...
        'invitations.invite': {
            ...
            'uuid': ('django.db.models.fields.CharField', [], {'default': "'b6f7d5d7753511e2aa9d14109fe01d13'", 'max_length': '100'})
        },
        'invitations.passwordreset': {
            'Meta': {'object_name': 'PasswordReset'},
            'date_issued': ('django.db.models.fields.DateTimeField', [], {'auto_now_add': 'True', 'blank': 'True'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'user': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['auth.User']"}),
            'uuid': ('django.db.models.fields.CharField', [], {'default': "'b6f84868753511e2b19514109fe01d13'", 'max_length': '100'})
        },
        'invitations.registration': {
            ...
            'used': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
            'user': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['auth.User']"}),
            'uuid': ('django.db.models.fields.CharField', [], {'default': "'b6f8250f753511e2a35314109fe01d13'", 'max_length': '100'})
        }
    }
