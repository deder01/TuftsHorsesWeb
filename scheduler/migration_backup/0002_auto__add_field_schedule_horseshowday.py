...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Schedule.horseshowday'
        db.add_column('scheduler_schedule', 'horseshowday',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['horseshow.HorseShowDay']),
                      keep_default=False)
    ...
    models = {
        ...
        'scheduler.schedule': {
            ...
            'horseshowday': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['horseshow.HorseShowDay']"}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
