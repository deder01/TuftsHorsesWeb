...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Schedule.horseshowday'
        db.alter_column('scheduler_schedule', 'horseshowday_id', self.gf('django.db.models.fields.related.OneToOneField')(to=orm['horseshow.HorseShowDay'], unique=True))
        # Adding unique constraint on 'Schedule', fields ['horseshowday']
        db.create_unique('scheduler_schedule', ['horseshowday_id'])


    def backwards(self, orm):
        # Removing unique constraint on 'Schedule', fields ['horseshowday']
        db.delete_unique('scheduler_schedule', ['horseshowday_id'])


        # Changing field 'Schedule.horseshowday'
        db.alter_column('scheduler_schedule', 'horseshowday_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['horseshow.HorseShowDay']))
    ...
    models = {
        ...
        'scheduler.schedule': {
            ...
            'horseshowday': ('django.db.models.fields.related.OneToOneField', [], {'to': "orm['horseshow.HorseShowDay']", 'unique': 'True'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
