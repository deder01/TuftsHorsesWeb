...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Schedule.horseshowday'
        db.delete_column('scheduler_schedule', 'horseshowday_id')

        # Adding field 'Schedule.ring'
        db.add_column('scheduler_schedule', 'ring',
                      self.gf('django.db.models.fields.related.OneToOneField')(default=0, to=orm['horseshow.Ring'], unique=True),
                      keep_default=False)


    def backwards(self, orm):

        # User chose to not deal with backwards NULL issues for 'Schedule.horseshowday'
        raise RuntimeError("Cannot reverse this migration. 'Schedule.horseshowday' and its values cannot be restored.")
        # Deleting field 'Schedule.ring'
        db.delete_column('scheduler_schedule', 'ring_id')
